...
def main(mult_fasta:str, zorro_cmd:str, tree_cmd:str, threshold:float, ouf_file:str)->None:
    ...
    :param mult_fasta: multiple alignemnt in fasta format
    :param zorro_cmd: path to zorro executable
    :param tree_cmd: command for tree tool
    :param threshold: threshold for filtering unconficent alignement
    :param ouf_file: out_File storing the filtered alignment
    :return: nothing
    """
